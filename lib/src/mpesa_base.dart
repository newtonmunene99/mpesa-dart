...
import 'mpesa_base/mpesa_response.dart';
...
class Mpesa {
  ...
  Future<MpesaResponse> lipaNaMpesa({
    ...
    final _timestamp = _generateTimestamp(_now);
    final String _password = _generatePassword(_payBill, _timestamp);
  ...
  String _generatePassword(String paybill, String timestamp) {
    final String _rawPassword = paybill + _passKey + timestamp;
    final List<int> _passwordBytes = utf8.encode(_rawPassword);
    return base64.encode(_passwordBytes);
  }
}
